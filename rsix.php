    ...
    ?>
        <main>
            <section class="main">
                ...
                <div>
                        <div class="online">
                            <h3 class="direct">Résultat - <span class="league">Rainbow Six Siege</span></h3>
                        </div>
                        <div>
                          <h4 class="shoot">LEC 2024 Spring</h4>
                            <div class="match">
                                ...
                                $endpoint = 'https://api.pandascore.co/r6siege/matches/past?token=' . $apiKey;
                ...
                <div class="section right_block">
                    <img class="picture" src="./Asset/img/rainbow.png" alt="af">
                    <div class="mrg">
