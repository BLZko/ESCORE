    ...
    ?>
        <main>
            <section class="main">
                ...
                <div>
                        <div class="online">
                            <h3 class="direct">Résultat - <span class="league">Call of Duty</span></h3>
                        </div>
                        <div>
                          <h4 class="shoot">LEC 2024 Spring</h4>
                            ...
                            $endpoint = 'https://api.pandascore.co/codmw/matches/past?token=' . $apiKey;
                ...
                <div class="section right_block">
                    <img class="picture" src="./Asset/img/Call-of-Duty-Logo (1).png" alt="af">
                    <div class="mrg">
