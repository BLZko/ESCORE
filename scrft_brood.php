        ...
        <main>
            <section class="main">
                ...
                <div class="section middle_block">
                    <div>
                        <div class="online">
                            <h3 class="direct">Résultat - <span class="league">Starcraft Brood War</span></h3>
                        </div>
                        <div>
                          <h4 class="shoot">LEC 2024 Spring</h4>
                            <div class="match">
                                ...
                                $endpoint = 'https://api.pandascore.co/starcraft-brood-war/matches/past?token=' . $apiKey;
                ...
                <div class="section right_block">
                    <img class="picture" src="./Asset/img/csgooo.png" alt="af">
                    <div class="mrg">
