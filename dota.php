        ...
        <main>
            <section class="main">
                ...
                <div class="section middle_block">
                     <div>
                        <div class="online">
                            <h3 class="direct">Résultat - <span class="league">DOTA</span></h3>
                        </div>
                        <div>
                          <h4 class="shoot">LEC 2024 Spring</h4>
                            ...
                            $endpoint = 'https://api.pandascore.co/dota2/matches/past?token=' . $apiKey;
                ...
                <div class="section right_block">
                    <img class="picture" src="img/Logo-LoL-removebg-preview.png" alt="af">
                    <div class="mrg">
